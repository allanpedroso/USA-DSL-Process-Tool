                ...
                <fieldset>
                    ...
                    <div id="checklistEvalPost">
                        <form action="">
                            ...
                            <div>
                                ...
                                <table class="table table-responsive-lg">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="align-middle">Severity (Check each of the problems
                                            found)
                                        </th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr class=" text-justify">
                                        <td>Does the Graphical DSL provide immediate and adequate feedback on its status
                                            for each user action? For example, after an include or exclude task the
                                            language displays a commit message?
                                        </td>
                                        <td class="justify-content-center">
                                            <div class="form-check"><input class="form-check-input text-center"
                                                                           type="radio" name="q1h1apply" value="apply">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-check"><input class="form-check-input text-center"
                                                                           type="radio" name="q1h1apply"
                                                                           value="ntapply"></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Does the Textual DSL provide immediate and adequate feedback on its status
                                            for each user action? For example, after an include or exclude task the
                                            language displays a commit message?
                                        </td>
                                        <td>
                                            <div class="form-check"><input class="form-check-input" type="radio"
                                                                           name="q2h1apply" value="apply"></div>
                                        </td>
                                        <td class="text-center">
                                            <div class="form-check"><input class="form-check-input d-block" type="radio"
                                                                           name="q2h1apply" value="ntapply"></div>
                                        </td>
                                        <td><textarea name="descError" rows="4"></textarea></td>
                                        <td><select class="form-control text-center" name="severity" id="severity">
                                                <option value="1">1</option>
                                    ...
                                    <tr>
                                        <td>Do the elements available for the user specifically execute only one
                                            command? For example, the "undo" button only performs undo actions.
                                        </td>
                                        <td>
                                            <div class="form-check"><input class="form-check-input" type="radio"
                                                                           name="q3h1apply" value="apply"></div>
                                        </td>
                                        <td>
                                            <div class="form-check"><input class="form-check-input" type="radio"
                                                                           name="q3h1apply" value="ntapply"></div>
                                        </td>
                                        <td><textarea name="descError" rows="4"></textarea></td>
                                        <td><select class="form-control text-center" name="severity" id="severity">
                                                <option value="1">1</option>
                                    ...
                                    <tr>
                                        <td>Do all alert and error messages that DSL (Textual or Grafica) provides stay
                                            on the screen long enough to be read more than once or (preferably) until
                                            the user chooses to close them?
                                        </td>
                                        <td>
                                            <div class="form-check"><input class="form-check-input" type="radio"
                                                                           name="q4h1apply" value="apply"></div>
                                        </td>
                                        <td>
                                            <div class="form-check"><input class="form-check-input" type="radio"
                                                                           name="q4h1apply" value="ntapply"></div>
                                        </td>
                                        <td><textarea name="descError" rows="4"></textarea></td>
                                        <td><select class="form-control text-center" name="severity" id="severity">
                                                <option value="1">1</option>
                                    ...
                                    <tr>
                                        <td>Are the Textual and Graphical DSLs structured in a coupled way? For example,
                                            if the user changes something on the Textual DSL, this change must be
                                            observed on the Graphical DSL and if the user changes something on the
                                            Visual DSL, this change must be observed on the Textual DSL.
                                        </td>
                                        <td>
                                            <div class="form-check"><input class="form-check-input" type="radio"
                                                                           name="q5h1apply" value="apply"></div>
                                        </td>
                                        <td>
                                            <div class="form-check"><input class="form-check-input" type="radio"
                                                                           name="q5h1apply" value="ntapply"></div>
                                        </td>
                                        <td><textarea name="descError" rows="4"></textarea></td>
                                        <td><select class="form-control text-center" name="severity" id="severity">
                                                <option value="1">1</option>
                            ...
                            <div>
                                <table class="table table-responsive-lg">
                                    <p class="card-subtitle p-4 mt-2">Match between language and the real world
                                        domain </p>
                                    <thead>
                                    <tr>
                                        <th scope="col" class="align-middle">Question</th>
