    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xs-12  w-50 p-2">
                <form id="planningPhase" class="sf-border" action="{{ route('newProject.store') }}" method="post">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-3 ml-2">
                                <button type="button" class="btn btn-block bg-gradient-primary btn-sm"><i
                                        class="fas fa-plus mr-2"></i>Add profile
                                </button>
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="col-lg-6 col-xs-6 pt-lg-3">
                            ...
                            <div class="form-group">
                                <input type="checkbox" name="instrument" value="profileQuestionnaire"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6 col-md-12 mt-3">
                                            <button type="button" class="btn btn-block bg-gradient-primary btn-sm"><i
                                                    class="fas fa-plus mr-2"></i>Add file
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <fieldset>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-12 col-md-3 mt-3 ">
                                <button type="button" class="btn btn-block bg-gradient-primary btn-sm"><i
                                        class="fas fa-plus mr-2"></i>Add scenario
                                </button>
                            </div>
                        </div>
                    </fieldset>
